    ...
    <div className="min-h-[80vh] flex items-center justify-center px-4">
      ...
      >
        <div className="text-center mb-10">
          ...
          <h2 className="text-3xl font-display font-black tracking-tighter text-white mb-2">Create Account</h2>
          <p className="text-white/50 text-sm">Join the WIBE community today.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-2">
            ...
            <div className="relative group">
              <User className="absolute left-4 top-1/2 -translate-y-1/2 w-5 h-5 text-white/20 group-focus-within:text-accent-blue transition-colors" />
              <input 
                type="text" 
                value={name}
